  ...
  return (
    <Layout>
      ...
      >
        ...
        {/* contenedor correspondiente a la tabla de datos de categorias */}
        {/* las columnas tienen los titulos de: id, nombre, productos, status y acciones */}
        ...
        <div className="border-[1px] border-[var(--gray)] mt-3 py-2 px-5 rounded-md w-max">
          <div className="flex items-center gap-5">
            <button
              ...
              className={`${
                pageSelected === 1
                  ? "bg-[var(--lightgray)] rounded-md font-medium"
                  : "bg-[var(--dark)] text-white"
              } w-10 h-10 border-r-[1px] border-r-[var(--gray)]`}
            >
              1
            </button>
            <button
